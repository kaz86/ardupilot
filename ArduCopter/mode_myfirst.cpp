...
void ModeMyfirst::run()
{
    ...
    //右回転
    float target_yaw_rate = get_pilot_desired_yaw_rate(test_yaw_balue);

    */

    //float target_yaw_rate = get_pilot_desired_yaw_rate(1.0);

    //左回転
    //float target_yaw_rate = get_pilot_desired_yaw_rate(-1.0);

    //↓NG
    //float target_yaw_rate = 200;
    //float target_yaw_rate = -1.0;
    ...
    //target_euler_deg = target_euler_deg + 30.0f;
